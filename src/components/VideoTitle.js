...
const VideoTitle = ({title, overview}) => {
  return (
    <div className='pt-52 md:pt-48 px-6 md:px-12 absolute bg-gradient-to-r from-black aspect-video'>
        <h1 className='text-xl md:text-5xl font-bold text-white'>{title}</h1>
        <p className='hidden md:block py-6 text-lg w-1/2 text-white'>{overview}</p>
        <div className='flex gap-2'>
            ...
            <button className='bg-gray-400 text-white p-1 md:p-3 px-3 md:px-6 rounded-sm bg-opacity-40 border border-gray-400 text-lg hover:bg-opacity-5'>
                More Info
            </button>
        </div>
    </div>
